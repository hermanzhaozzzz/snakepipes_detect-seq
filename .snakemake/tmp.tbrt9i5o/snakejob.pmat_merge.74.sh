#!/bin/bash
# properties = {"type": "single", "rule": "pmat_merge", "local": false, "input": ["../mpileup_pmat_bmat/293T-bat_VEGFA-All-PD_rep1_hg38.MAPQ20.select.T.pmat"], "output": ["../mpmat/293T-bat_VEGFA-All-PD_rep1_hg38.MAPQ20.select.T2G.mpmat"], "wildcards": {"sample": "VEGFA-All-PD", "rep": "rep1", "from_base": "T", "to_base": "G"}, "params": {"from_base": "T", "to_base": "G"}, "log": ["../mpmat/293T-bat_VEGFA-All-PD_rep1_hg38.MAPQ20.select.T2G.mpmat.log"], "threads": 1, "resources": {}, "jobid": 74, "cluster": {}}
...
-m snakemake ../mpmat/293T-bat_VEGFA-All-PD_rep1_hg38.MAPQ20.select.T2G.mpmat --snakefile /gpfs/user/zhaohuanan/3.project/10.2020-09_0923_Practice_for_detect-seq-data/snakepipes_detect-seq_fastq_bam_plot/snk.1.bam2mpmat.py \
