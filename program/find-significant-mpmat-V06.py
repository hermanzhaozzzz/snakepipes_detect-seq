...
from DetectSeqLib_V2_1.CalculateBackground import *
from DetectSeqLib_V2_1.CheckAndLoadFiles import *
from DetectSeqLib_V2_1.OutputAndClearTemp import *
from DetectSeqLib_V2_1.RegionStatsTest import *
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lambda_method",
                        help="Can be set as 'ctrl_max', 'treat_max', 'max', 'raw', default=ctrl_max", default="ctrl_max")
